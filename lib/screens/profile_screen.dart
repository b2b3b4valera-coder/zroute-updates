...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _pickAndUploadAvatar() async {
    ...
    try {
      ...
      List<dynamic> photos = List.from(currentData['photos'] ?? []);
      ...
      if (photos.isEmpty && currentData['avatarUrl'] != null && (currentData['avatarUrl'] as String).isNotEmpty) {



        photos.add(currentData['avatarUrl']);
  ...
  Future<void> _deleteCurrentAvatar() async {
    ...
    try {
      ...
      String newAvatar = photos.isNotEmpty ? photos.last : '';
